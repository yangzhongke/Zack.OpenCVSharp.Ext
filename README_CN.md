...
**ResourceTracker已经贡献到OpenCvSharp4的最新版中，并且更名为ResourcesTracker，详情查看[OpenCvSharp4文档](https://github.com/shimat/opencvsharp) ，[PullRequest说明](https://github.com/shimat/opencvsharp/pull/1110)。这里的ResourceTracker将不会再维护。**
